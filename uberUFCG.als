...
* Pedro Manoel
*
* Mini-projeto de Lógica (Uber UFCG)
**/
...
-- Fatos
fact RegrasUberUFCG {
    -- uma pessoa não pode ser motorista e passageiro de uma mesma corrida
    ...
    all c1:Ida, c2:Ida | ((c1.horario = c2.horario) and c1 != c2)  implies (#(c1.passageiros & c2.passageiros) = 0) and (#(c1.motorista & c2.motorista) = 0) and  (#(c1.motorista & c2.passageiros) = 0)  and  (#(c2.motorista & c1.passageiros) = 0)
    all c1:Volta, c2:Volta | ((c1.horario = c2.horario) and c1!=c2)  implies (#(c1.passageiros & c2.passageiros) = 0) and (#(c1.motorista & c2.motorista) = 0) and  (#(c1.motorista & c2.passageiros) = 0)  and  (#(c2.motorista & c1.passageiros) = 0)
